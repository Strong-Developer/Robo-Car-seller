...
function initChatMsgs(){
    curStep = 1;
    chatMsgs[1]=[];
    chatMsgs[1][0] = ['Our purpose is to give you a seamless & quick access to most information <ul><li>We have this automobile <b>available</b></li><li>Please click on <u><b>vehicle history report.</b></u> </li><li>Coming soon: List of available <b>rebates/discounts.</b> </li></ul>'];
    ...
    event.preventDefault();
      ...
      stripe.createToken(card).then(function(result) {
        if (result.error) {
          ...
          var host = 'http://localhost/umpdemo/';
          $.ajax({
