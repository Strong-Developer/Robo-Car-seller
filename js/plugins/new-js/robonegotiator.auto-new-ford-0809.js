...
function option1() {
    ...
    _customerReply(theEnvelop);
    let theEnvelope = {
        msg: "We have the following additional information regarding this vehicle. Would you like to view any of them? If not, Select \"I Still Have a Question\" <div class=\"inner\"><button type=\"button\" id=\"closebotbtn\"    class=\"dha-choose-button\">Vehicle Specifications</button></div><div class=\"inner\"><button type=\"button\" id=\"closebotbtn\"   class=\"dha-choose-button\">Cost Of OwnerShip</button> </div> <div class=\"inner\"><button type=\"button\" id=\"closebotbtn\"  onclick=\"option3()\"  class=\"dha-choose-button\">Title/Lien/Accident Report</button></div><div class=\"inner\"><button type=\"button\" id=\"closebotbtn\"   class=\"dha-choose-button\">Market Data</button></div><div class=\"inner\"><button type=\"button\" id=\"closebotbtn\"   class=\"dha-choose-button\">Full Report</button></div><div class=\"inner\"><button type=\"button\" id=\"closebotbtn\"  onclick=\"option_custom()\" class=\"dha-choose-button\">I Still Have a Question</button></div><div class=\"inner\"><button type=\"button\" id=\"closebotbtn\"  onclick=\"document.getElementById('dha_robonegotiator_btn_start').click()\" class=\"dha-choose-button\">Go Back</button></div>",
        sender: false
    }
    setTimeout(function () {
        _autoSend(theEnvelope);     
...
function confirmFinanceCreditScoreOptions() {
    ...
    if(buyerFinanceOptionsValueCreditScore != ''){
        ...
        _autoSend(theEnvelope);
        setTimeout(function () {
            var leaseTadeInMessage = "Enter your upfront payment / security deposit/ down payment: <div id='finance_options_tradein_mssg'><div class='inline-box'>"+selectCurrency+"<input style='width:75%;font-size: 18px;border: 1px solid #84b3a9;border-radius: 5px;' type='text' class='form-control oracle-search' name='finance_upfront_payment'  placeholder='Please enter value' id='finance_upfront_payment_text'> <button type='button' id='finance_upfront_payment_text_bttn' onClick='goToFinanceTradeIn()' class='inline-submit sound-on-click'><img src='"+API_ENDPOINT+"/js/plugins/assets/img/icon_send.png' width='30px;'></button></div> </div>";
            textClass = 'text-danger';
            let theEnvelope = {
...
function goToMonthlyPaymentFinance() {
    ...
    var mssg = "Enter your estimated monthly payment you are willing to pay for this vehicle:  <div id='estimated_monthly_install_section'><div class='inline-box'>"+selectCurrency+"<input style='width:75%;font-size: 18px;border: 1px solid #84b3a9;border-radius: 5px;' type='text' class='form-control oracle-search' name='estimated_monthly_payment'  placeholder='Please enter value' id='finance_estimated_monthly_payment'> <button type='button' id='finance_estimated_monthly_payment_bttn' onClick='showFinanceOptionMssgsecond()' class='inline-submit sound-on-click'><img src='"+API_ENDPOINT+"/js/plugins/assets/img/icon_send.png' width='30px;'></button></div></div>";
    textClass = 'text-danger';
    let theEnvelope = {
        msg: mssg,
        sender: false
...
function showFinanceOptionMssgsecond() {
    ...
    if(financeEstimatedMonthlyPayment != '') {
        ...
        var mssg33 = "Please enter your highest monthly installment amount:   <div id='highest_monthly_install_section'><div class='inline-box'>"+selectCurrency+"<input style='width:75%;font-size: 18px;border: 1px solid #84b3a9;border-radius: 5px;' type='text' class='form-control oracle-search' name='highest_monthly_payment'  placeholder='Please enter value' id='highest_monthly_payment_finance'> <button type='button' id='highest_monthly_payment_finance_bttn' onClick='financeAboutToCheck()' class='inline-submit sound-on-click'><img src='"+API_ENDPOINT+"/js/plugins/assets/img/icon_send.png' width='30px;'></button></div></div>";
         theEnvelope = {
            msg: mssg33,
            sender: false
        };
                ...
                if (data2.message !== undefined) {
                    if (data2.message === 'failed') {
                        ...
                        if( leaseCheckAgainCustom == 1) {
                            ...
                            var mssg33898 = "Give your final/ highest monthly installment offer: <div id='highest_monthly_install_section_again'><div class='inline-box'>"+selectCurrency+"<input style='width:75%;font-size: 18px;border: 1px solid #84b3a9;border-radius: 5px;' type='text' class='form-control oracle-search' name='highest_monthly_payment_again'  placeholder='Please enter value' id='highest_monthly_payment_finance_again'> <button type='button' id='highest_monthly_payment_finance_bttn_again' onClick='updateBuyerFinanceParam()' class='inline-submit sound-on-click'><img src='"+API_ENDPOINT+"/js/plugins/assets/img/icon_send.png' width='30px;'></button></div></div>";
                            theEnvelope = {
                                msg: mssg33898,
                                sender: false
                            };
                        ...
                        xmlhttpFinanceClose.onreadystatechange = function () {
                            if (this.readyState === 4 && this.status === 200) {
                                ...
                                if (data.closed_deal === undefined) {
                                    ...
                                    var financeParamValues = buyerFinanceOptionsValueCreditScore.split('|');
                                    var offerMessage = '<span style="color:#fff;">Congratulations!! ';
        ...
        xmlHttpSellerFinanceUpdate.onreadystatechange = function () {
            if (this.readyState === 4 && this.status === 200){
                ...
                if (data.success) {
                    ...
                    var askForCommentMssg ="<div class='robo-custom-control custom-radio'><textarea class='form-control oracle-search' id='askForFinanceComment' placeholder='Please enter message.' style='color:#000;font-size: 18px;border: 1px solid #84b3a9;border-radius: 5px;' name='option1_buyer_message'></textarea></div><div align='right'><button type='button' class='dha-find-seller-button' id='finance_ask_for_comment' onclick='checkDealAgainFunctionFinance(event)'>Proceed <i class='fa fa-arrow-right' aria-hidden='true'></i></button></span></div>";
                    textClass = 'text-danger';
                    final_message = {
...
function confirmLeaseProduct(e){
 ...
 function confirmLeaseMonthOptions() {
    ...
    if(buyerLeaseOptionsValueMonth != ''){
        ...
        var chooseMonthMiletMessage = "Please select annual miles limit you need (* please check with dealer for additional miles cost): <div class='robo-custom-control custom-radio'>"+optionLeaseMilesHtml+"</div><div align='right'><button type='button' class='dha-find-seller-button' id='confirm_lease_mile_options' onclick='confirmLeaseMileOptions(event)'>Proceed <i class='fa fa-arrow-right' aria-hidden='true'></i></button></div>";
        textClass = 'text-danger';
        let theEnvelope = {
            msg: chooseMonthMiletMessage,
            sender: false
...
function goToLeaseTradeIn() {
    ...
    if(leaseUpfrontPayment != '') {
        ...
        var leaseTadeInMessage = "Are you planning to trade in a car?<div class='robo-custom-control custom-radio'><input id='leasing_tradein_option2_yes' type='radio' class='inline-radio' name='leasing_tradein_option2_select' value='yes'><label for='leasing_tradein_option2_yes'><span></span>Yes</label><input id='leasing_tradein_option2_no' type='radio' class='inline-radio' name='leasing_tradein_option2_select' value='no'><label for='leasing_tradein_option2_no'><span></span>No</label></div><div align='right'><button type='button' class='dha-find-seller-button' id='lease_mssg_confirm_lease_tradein' onclick='confirmLeaseTradeIn(event)'>Proceed <i class='fa fa-arrow-right' aria-hidden='true'></i></button></span></div>";
        textClass = 'text-danger';
        let theEnvelope = {
            msg: leaseTadeInMessage,
            sender: false
        ...
        xmlHttpSellerLeaseUpdate.onreadystatechange = function () {
            if (this.readyState === 4 && this.status === 200){
                ...
                if (data.success) {
                    ...
                    var askForCommentMssg ="<div class='robo-custom-control custom-radio'><textarea class='form-control oracle-search' style='width:75%;font-size: 18px;border: 1px solid #84b3a9;border-radius: 5px;color: black' id='askForLeaseComment' placeholder='Please enter message.' style='color:#fff;' name='option1_buyer_message'></textarea></div><div align='right'><button type='button' class='dha-find-seller-button' id='lease_ask_for_comment' onclick='checkDealAgainFunction(event)'>Proceed <i class='fa fa-arrow-right' aria-hidden='true'></i></button></span></div>";
                    textClass = 'text-danger';
                    final_message = {
                        msg: askForCommentMssg,
                        sender: false ,
