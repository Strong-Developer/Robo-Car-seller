...
/*if (typeof ROBO_LOGO_URL === 'undefined') {
    var ROBO_LOGO_URL = 'https://sandbox.robonegotiator.com/js/plugins/assets/img/chat2.png';

}*/
if (typeof ROBO_LOGO_URL === 'undefined') {
    var ROBO_LOGO_URL = 'https://devsandbox.robonegotiator.com/js/plugins/new-js/Toyota-square.png';
}
...
if(ROBO_NEGOTIATION_MODE === 'auto') {
    if(clientSetCategory === 'car' || clientSetCategory === 'automobile' || clientSetCategory === 'vehicle' || clientSetCategory === 'Automobiles'){
		    ...
		    ROBO_LOGO_URL = 'https://devsandbox.robonegotiator.com/js/plugins/new-js/Searchoptics.png';
            ...
            ROBO_LOGO_URL = 'https://devsandbox.robonegotiator.com/js/plugins/new-js/Walmart-Logo.png';
