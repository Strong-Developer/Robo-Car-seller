        ...
        if (count_progress === 1) {
            ...
            if (counterPrice !== undefined) {
                ...
                var url = 'https://market.RoboNegotiator' +
                    '.com/api-786-instant-deal-check?api_key='+api_key+'&upc_product_code=' +
                    product_code +
                    '&seller_email' +
                    '=' + seller_email;
...
function getDealStatus() {
    var url = "https://market.RoboNegotiator.com/api-786-get-deal-status?api_key=" + api_key + "&upc_product_code=" +
        product_code +
        "&request_id=" + buyer_offer_request_id;
    var xmlhttp = new XMLHttpRequest();
    xmlhttp.open("GET", url, true);
...
function save_buyer_payment($paymentObj) {
    ...
    var url = "https://market.RoboNegotiator.com/api-786-save-payment-info?" + urlPostfix;
    var xmlhttp = new XMLHttpRequest();
...
function getFinalAmount() {
    ...
    function getAmount() {
        var url = "https://market.RoboNegotiator.com/api-786-getDealStatus?api_key=" + api_key + "&upc_product_code=" +
            product_code +
            "&request_id=" + buyer_offer_request_id;
        var xmlhttp = new XMLHttpRequest();
        xmlhttp.open("GET", url, true);
