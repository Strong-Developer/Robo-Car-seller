                ...
                if (data2.message !== undefined) {
                    if (data2.message === 'failed') {
                       ...
                       // alert('tetette');
                        ...
                        let theEnvelope = {
                            msg: '<span class="text-success">Congratulations!! We have a matching deal from our seller, and we would like to close the deal. Our seller has agreed to meet your needs.</span>',
                            sender: false
                        };
                        _autoSend(theEnvelope);
                        let credit_report = {
                ...
                if (data.closed_deal === undefined) {
                    ...
                    if (preferences !== undefined) {
                        ...
                        if(parseInt(data.closed_deal[0].total_discounted_amount) > 0) {
                           ...
                           var discountMssgText = 'For your information:  We have already applied USD '+roboCurrency+' '+data.closed_deal[0].total_discounted_amount+' discount/rebate (seller paid) while calculating this negotiation price.';
                            //"Good News!! We have also secured additional dealer paid discount in final price. While total price may seem higher, you're getting <b>$"+data.closed_deal[0].total_discounted_amount+"</b> from the dealer",
                            discountMssg = {
                        ...
                        if (agreedAmount !== 0) {
                            ...
                            var depositMessage = {
                                msg: '<span class="text-success">To secure a deal so it is guaranteed, please pay deposit <b> '+ roboCurrency + " " + agreedAmount + ' deposit</b> to Seller.</span>',
                                sender: false ,
