...
<header class="main-header  header-with-top font-weight-bold black z-depth-3" >
    <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #007bff;">
        <a class="navbar-brand company-logo" href="javascript:void(0);"  style="padding: 0 !important;margin:  0
            !important;">

            <img src="/afterlogin_assets/images/icon/logo.png" alt="RoboNegotiator" width="200px" >
        </a>
...
{{--                    </li>--}}
                    <li class="nav-item dropdown">
                        <a  href="{{route('admin.products.manage')}}" class="nav-link nav-link
                        font-weight-bold text-white" style="background-color: steelblue;">
                            <i class="fa fa-file-code"></i> Manage Products
                        </a>
                    </li>
                    <li class="nav-item dropdown">
                        <a  href="{{route('admin.sellers.manage')}}" class="nav-link nav-link
                        font-weight-bold text-white" style="background-color: steelblue;">
                            <i class="fa fa-file-code"></i> Manage Sellers
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link font-weight-bold" href="{{route('admin.logout')}}" style="background-color: steelblue;"><i
