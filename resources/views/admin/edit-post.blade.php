        ...
        <div class="col-12">
            ...
            <div class="card mb-5">
                ...
                <div class="card-header">
                    ...
                    <p class="font-weight-bold float-left">Edit {{app('request')->get('post_type')}} @if($post->name !== null)
                            ({{$post->name}}) @endif</p>

                    @if($post->name !== null)
                    <a class="btn btn-primary float-right" href="{{route('page.custom',['page_url' => $post->page_url])
                    }}">Preview this page</a>
                        <a class="btn btn-primary float-right" href="{{route('admin.cms.create_page',['clone_id' =>
                ...
                <div class="card-body">
                    ...
                    <form class="row" method="post" action="{{route('admin.cms.update_page')}}"> {{csrf_field()}}
                        ...
                        <input type="hidden" name="post_type" value="{{app('request')->get('post_type')}}">
                        <input type="hidden" name="post_id" value="{{$post->id}}">
                        <div class="col-12">
                            <div class="form-group">

                                <label>{{app('request')->get('post_type')}} content</label>

                                <textarea required name="content" id="summernote" class="md-textarea
                                form-control">{!! html_entity_decode($post->content) !!}</textarea>
