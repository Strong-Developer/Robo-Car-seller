              ...
              <!--  <h3 class="font-weight-bold mb-4 my-2 text-center">Add New Deal</h3>
               ...
               <div class="row flex-center" >
                  <div class="col-md-12">
                     ...
                     <form enctype="multipart/form-data" action="{{route('import.csv')}}" method="post">
                        {{csrf_field()}}
                        <div class="form-group">
                           <label>Upload CSV File (<a href="{{url('storage/app/public/deals.csv')}}">Download demo csv to
                           view
                           correct
                           format</a>)
                           </label>
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          <div class="form-group">
                            ...
                            <label class="control-label">Upload Bulk Deals from CSV file(<a href="{{url('storage/app/public/deals.csv')}}">Download demo csv to
                           view
                           correct
                           format</a>)</label>
                ...
                <div class="panel panel-primary">
                  <div class="panel-heading">
                    ...
                    <a style="margin-top: -15px;margin-right:5px;" href="{{url('/import-history')}}" class="btn btn-success btn-flat btn-lg float-right"><i class="fa fa-upload" aria-hidden="true"></i> Import History & Status</a>

                    <button type="button" style="margin-top: -15px;margin-right:5px;" class="btn btn-success btn-flat btn-lg float-right" data-toggle="modal" data-target=".bd-example-modal-lg"><i class="fa fa-upload" aria-hidden="true"></i> Bulk Upload</button>
                  </div>
                  <div class="panel-body">

                    <div class="row">
                      <div class="col-md-12">
                        @if (Session::has('errors_seller'))
                        @if (Session::get('errors_seller') > 0 )
                        <div class="alert alert-danger alert-block">
                            <button type="button" class="close" data-dismiss="alert">×</button>
                            <strong>{{Session::get('errors_seller') }} Products failed to import</strong>
                        </div>
                        @endif
                        @endif
                    ...
                    <form action="{{route('addProduct.submit')}}" method="post" id="add-deal-form" enctype="multipart/form-data">
                      {{csrf_field()}}
                      <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                          <div class="row">
                            ...
                            <div class="col-md-12">
                              <div class="form-group">
                                <textarea class="form-control" placeholder="Enter Some Product Description to Proceed" rows="5" id="product_description" name="product_description"></textarea>
                              </div>
                            </div>
                            <!-- File Upload Section -->
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <span class="btn btn-default btn-file">
                                    <input id="input-1" name="product_img[]" type="file" accept="image/*"  class="file form-control" multiple data-show-upload="false" data-show-caption="true" data-initial-preview-show-delete="true">
                                </span>
                            </div>
                            <div class="form-group">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-6">
                               <div class="form-group">
                                  ...
                                  @if(Auth::user()->negotiation === 'auto') required  @endif   value="{{old
                                  ('lowest_price')
                                  }}">
                               </div>
                            </div>
                            <div class="col-md-6">
                               <div class="form-group">
                                  ...
                                  @endif
                                  <input type="text" class="form-control" placeholder="Quantity Available for this deal *" required name="seller_original_quantity" value="{{old('seller_original_quantity')}}">
                               </div>
                            </div>
                            ...
                            <div class="col-md-6">
                               <div class="form-group">
                                  ...
                                  <input type="text" onfocus="(this.type='date')" class="form-control" placeholder="Deal Expiry Date *"
                                     id="datePicker" name="expiry_date" value="{{old('expiry_date')}}" required>
                               </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="col-md-12">
                         <button id="up_button"  type="button" class="btn btn-lg btn-block" style="background-color: #00aeef; color: #fff;">
...
$(document).ready(function(){
    $('#add-deal-form').validate();
    $('#up_button').click(function(){
        if($('#add-deal-form').valid()){
            $('#up_button').hide();
        }
