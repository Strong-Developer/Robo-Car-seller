            ...
            <div class="product portfolio-item portfolio-item-style-2">
              <div class="image-frame image-frame-style-1 image-frame-effect-2 mb-3">
                <span class="image-frame-wrapper image-frame-wrapper-overlay-bottom image-frame-wrapper-overlay-light image-frame-wrapper-align-end">
                  ...
                  <span class="image-frame-action">
                    <a href="{{route('buyer.product.details')}}?upc_product_code=@{{ x.upc_product_code}}" class="btn btn-primary btn-rounded font-weight-semibold btn-v-3 btn-fs-2">Details</a>
                  </span>
                </span>
              </div>
              ...
              <div class="product-info d-flex flex-column flex-lg-row justify-content-between">
                <div class="product-info-title">
                  <h3 class="text-color-default text-2 line-height-1 mb-1"><a href="{{route('buyer.product.details')
                          }}?upc_product_code=@{{ x.upc_product_code}}">@{{ x.category}} : @{{ x.product_title }}</a></h3>
                ...
                <div class="detail">
                   <div class="row mb-2 rounded-bottom" style="padding-bottom: 8px;">
                      ...
                      <div class="col-md-12 flex-right float-right" style="padding: 0 !important; color: #fff; margin-top: -35px !important; display: inline-block;">
                         <a href="{{route('buyer.product.details')}}?upc_product_code=@{{ x.upc_product_code}}" class="btn btn-primary btn-flat float-right">View details &nbsp;<i style="margin-top: 3px !important;" class="fa fa-angle-right"></i>
                         </a>
                      </div>
                   </div>
                </div>
          ...
          <div class="col-auto">
            <nav aria-label="Page navigation example">
                <ul class="pagination mb-0">
                  <li class="page-item">
                      <a class="page-link prev" href="#" ng-click="getpaginationResult(prev_page_url)" aria-label="Previous">
                        <span><i class="fas fa-angle-left" aria-label="Previous"></i></span>
                      </a>
                  </li>
                  <li class="page-item active"><a class="page-link" href="#">1</a></li>
                  <li class="page-item">
                      <a class="page-link next" href="#" ng-click="getpaginationResult(next_page_url)" aria-label="Next">
