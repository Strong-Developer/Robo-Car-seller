    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                    <a href="{{route('home.main')}}" style="max-width: 300px;"><img src="afterlogin_assets/images/icon/logo.png" alt="logo" width="500px;"></a>
                </div>
            </div>
            <div class="main-menu">
                    ...
                    <nav>
                        <ul class="metismenu" id="menu">
                            <li @if (\Request::is('dashboard')) class="active" @endif >
                                <a href="{{route('dashboard')}}" aria-expanded="true"><i class="ti-home"></i><span>dashboard</span></a>
                               </li>
                            <li @if (\Request::is('manage-products')) class="active" @endif >
                                <a href="{{route('products.manage')}}" aria-expanded="true"><i class="fa fa-list-ul " aria-hidden="true"></i><span>Manage Products/Deals</span></a>
                            </li>
{{--                            <li  @if (\Request::is('upload-a-deal')) class="active" @endif >--}}
{{--                                <a href="{{route('addProduct')}}" aria-expanded="true"><i class="fa fa-upload" aria-hidden="true"></i><span>--}}
{{--                                    Upload Product &amp; Deal--}}
{{--                                    </span></a>--}}
{{--                            </li>--}}
{{--                            <li  @if (\Request::is('add-product-discount')) class="active" @endif >--}}
{{--                                <a href="{{ url('add-product-discount') }}" aria-expanded="true"><i class="fa fa-list-ul" aria-hidden="true"></i><span>--}}
{{--                                Set Discounts/Rebates--}}
{{--                                </span></a>--}}
{{--                            </li>--}}
                            <li  @if (\Request::is('manage-discounts-rebates')) class="active" @endif >
                                <a href="{{ url('manage-discounts-rebates') }}" aria-expanded="true"><i class="fa fa-list-ul" aria-hidden="true"></i><span>
                                Manage Discounts/Rebates
                                </span></a>
                            </li>
                            <li  @if (\Request::is('manage-lease-parameters')) class="active" @endif >
                                <a href="{{ url('manage-lease-parameters') }}" aria-expanded="true"><i class="fa fa-list-ul" aria-hidden="true"></i><span>
                                Manage Lease Parameters
                                </span></a>
                            </li>
                            <li  @if (\Request::is('manage-finance-parameters')) class="active" @endif >
                                <a href="{{ url('manage-finance-parameters') }}" aria-expanded="true"><i class="fa fa-list-ul" aria-hidden="true"></i><span>
                                Manage finance Parameters
                                </span></a>
                            </li>
                            <li @if (\Request::is('set-rules')) class="active" @endif >
                                <a href="{{route('setrules')}}" aria-expanded="true"><i class="ti-pie-chart"></i><span>Set Negotiation Parameters /Rules</span></a>
                            </li>

                            <li @if (\Request::is('getTranscription')) class="active" @endif >
                                <a href="{{route('getTranscription')}}" aria-expanded="true"><i class="fa fa-key" aria-hidden="true"></i><span>View Transcriptions</span></a>
                            </li>
                            <li>
                            ...
                            <li  @if (\Request::is('customer')) class="active" @endif >
                                <a href="{{route('customer')}}" aria-expanded="true"><i class="fa fa-user" aria-hidden="true"></i><span>Customer Profile</span></a>
                            </li>

                            <li>
                                <a href="{{route('logout')}}" aria-expanded="true"><i class="fa fa-sign-out" aria-hidden="true"></i><span>Logout</span></a>
                            </li>
                        </ul>
                    </nav>
                </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6 clearfix">
                        <div class="user-profile pull-right">
                            ...
                            <h4 class="user-name dropdown-toggle" data-toggle="dropdown"><small>Welcome</small><br/>{{Auth::user()->first_name}} {{Auth::user()->last_name}}<i class="fa fa-angle-down"></i></h4>
