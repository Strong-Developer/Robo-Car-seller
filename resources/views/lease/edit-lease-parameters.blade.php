            ...
            <section class="dark-grey-text">
                ...
                <div class="panel panel-primary">
                  ...
                  <div class="panel-body">
                    <form action="{{ route('edit-lease-parameters',['prodcode' => $productLeaseData->upc_product_code]) }}" method="post" id="edit-form">
                      {{csrf_field()}}
                      ...
                      <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="input-group mb-3">
                                            <input value="{{$productLeaseData->tax_rate}}" aria-describedby="basic-add1" required class="form-control" maxlength="5" value="" placeholder="Your State Tax Rate" type="number" name="state_tax_rate">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input value="{{$productLeaseData->money_factor}}" class="form-control" maxlength="8" value="" required placeholder="Money Factor" type="number" name="money_factor">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input value="{{$sellerDeal->seller_orignal_quantity}}" class="form-control" maxlength="4" value="" required  placeholder="Quantity For Leasing" type="number" name="quantity_for_leasing">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="row lease_section existed" id="lease_section_0">
                                        <div class="col-md-4">
                                            ...
                                            <input type="hidden" value="{{isset($productLeaseData->seller_lease_sub_parameters[0]->id)?$productLeaseData->seller_lease_sub_parameters[0]->id:''}}" name="lease_sub_parameter[0][id]"/>
                                            <input class="form-control" type="number" value="{{isset($productLeaseData->seller_lease_sub_parameters[0]->duration_in_month)?$productLeaseData->seller_lease_sub_parameters[0]->duration_in_month:''}}" name="lease_sub_parameter[0][duration_in_month]" required/>
                                        </div>
                                        <div class="col-md-4">
                                            <input class="form-control" value="{{isset($productLeaseData->seller_lease_sub_parameters[0]->miles_allowed_per_year)?$productLeaseData->seller_lease_sub_parameters[0]->miles_allowed_per_year:''}}" type="number" name="lease_sub_parameter[0][miles_allowed_per_year]" required/>
                                        </div>
                                        <div class="col-md-4">
                                            <input value="{{isset($productLeaseData->seller_lease_sub_parameters[0]->residual_value)?$productLeaseData->seller_lease_sub_parameters[0]->residual_value:''}}" class="form-control custom-residual-value" type="text" name="lease_sub_parameter[0][residual_value]" required/>
                                        </div>
                                    </div>
                                    <br>
                                    <?php
                                    ...
                                    $counter = 1;
                                    @endphp
                                    @foreach($productLeaseData->seller_lease_sub_parameters as $parameters)
                                    <div class="row lease_section existed" id="lease_section_{{$counter}}">
                                        <div class="col-md-4">
                                            <input type="hidden" class="existing_one" value="update" name="lease_sub_parameter[{{$counter}}][action]"/>
                                            <input type="hidden" value="{{isset($productLeaseData->seller_lease_sub_parameters[$counter]->id)?$productLeaseData->seller_lease_sub_parameters[$counter]->id:''}}" name="lease_sub_parameter[{{$counter}}][id]"/>
                                            <input value="{{isset($productLeaseData->seller_lease_sub_parameters[$counter]->duration_in_month)?$productLeaseData->seller_lease_sub_parameters[$counter]->duration_in_month:''}}" class="form-control" type="number" name="lease_sub_parameter[{{$counter}}][duration_in_month]" required/>
                                        </div>
                                        <div class="col-md-4">
                                            <input value="{{isset($productLeaseData->seller_lease_sub_parameters[$counter]->miles_allowed_per_year)?$productLeaseData->seller_lease_sub_parameters[$counter]->miles_allowed_per_year:''}}" class="form-control" type="number" name="lease_sub_parameter[{{$counter}}][miles_allowed_per_year]" required/>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="input-group mb-3">
                                                <input value="{{isset($productLeaseData->seller_lease_sub_parameters[$counter]->residual_value)?$productLeaseData->seller_lease_sub_parameters[$counter]->residual_value:''}}" class="custom-residual-value form-control" type="text" name="lease_sub_parameter[{{$counter}}][residual_value]" required/>
                                                <div class="input-group-append delete_lease"  counter="{{$counter}}">
                                                    <span class="input-group-text" id="basic-add{{$counter}}">
                                                        <i class="fa fa-trash" aria-hidden="true"></i>
                                                    </span>
                                                </div>
                                            </div>
                                            <label id="lease_sub_parameter[{{$counter}}][residual_value]-error" style="display:none;" class="error" for="lease_sub_parameter[{{$counter}}][residual_value]">This field is required.</label>
                                        </div>
                                    </div>
                                    @php
                                    $counter++;
