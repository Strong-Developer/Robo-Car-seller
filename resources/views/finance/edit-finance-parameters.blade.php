            ...
            <section class="dark-grey-text">
                ...
                <div class="panel panel-primary">
                  ...
                  <div class="panel-body">
                    <form action="{{ route('edit-finance-parameters',['prodcode' => $productFinanceData->upc_product_code]) }}" method="post" id="edit-form">
                      {{csrf_field()}}
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input class="form-control" maxlength="4" value="{{$sellerDeal->seller_orignal_quantity}}" required  placeholder="Quantity For Leasing" type="number" name="quantity_for_leasing">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="row finance_section existed" id="finance_section_0">
                                        <div class="col-md-4">
                                            ...
                                            <input type="hidden" value="{{isset($productFinanceData->seller_finance_sub_parameters[0]->id)?$productFinanceData->seller_finance_sub_parameters[0]->id:''}}" name="finance_sub_parameter[0][id]"/>
                                            <input class="form-control" type="number" step="any" value="{{isset($productFinanceData->seller_finance_sub_parameters[0]->interest_rate)?$productFinanceData->seller_finance_sub_parameters[0]->interest_rate:''}}" name="finance_sub_parameter[0][interest_rate]" required/>
                                        </div>
                                        <div class="col-md-4">
                                            <input class="form-control" value="{{isset($productFinanceData->seller_finance_sub_parameters[0]->duration_in_month)?$productFinanceData->seller_finance_sub_parameters[0]->duration_in_month:''}}" type="number" name="finance_sub_parameter[0][duration_in_month]" required/>
                                        </div>
                                        <div class="col-md-4">
                                            <input value="{{isset($productFinanceData->seller_finance_sub_parameters[0]->credit_score)?$productFinanceData->seller_finance_sub_parameters[0]->credit_score:''}}" class="form-control custom-residual-value" type="text" name="finance_sub_parameter[0][credit_score]" required/>
                                        </div>
                                    </div>
                                    <br>
                                    <?php
                                    ...
                                    $counter = 1;
                                    @endphp
                                    @foreach($productFinanceData->seller_finance_sub_parameters as $parameters)
                                    <div class="row finance_section existed" id="finance_section_{{$counter}}">
                                        <div class="col-md-4">
                                            <input type="hidden" class="existing_one" value="update" name="finance_sub_parameter[{{$counter}}][action]"/>
                                            <input type="hidden" value="{{isset($productFinanceData->seller_finance_sub_parameters[$counter]->id)?$productFinanceData->seller_finance_sub_parameters[$counter]->id:''}}" name="finance_sub_parameter[{{$counter}}][id]"/>
                                            <input value="{{isset($productFinanceData->seller_finance_sub_parameters[$counter]->interest_rate)?$productFinanceData->seller_finance_sub_parameters[$counter]->interest_rate:''}}" class="form-control" type="number" step="any" name="finance_sub_parameter[{{$counter}}][interest_rate]" required/>
                                        </div>
                                        <div class="col-md-4">
                                            <input value="{{isset($productFinanceData->seller_finance_sub_parameters[$counter]->duration_in_month)?$productFinanceData->seller_finance_sub_parameters[$counter]->duration_in_month:''}}" class="form-control" type="number" name="finance_sub_parameter[{{$counter}}][duration_in_month]" required/>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="input-group mb-3">
                                                <input value="{{isset($productFinanceData->seller_finance_sub_parameters[$counter]->credit_score)?$productFinanceData->seller_finance_sub_parameters[$counter]->credit_score:''}}" class="custom-residual-value form-control" type="text" name="finance_sub_parameter[{{$counter}}][credit_score]" required/>
                                                <div class="input-group-append delete_finance"  counter="{{$counter}}">
