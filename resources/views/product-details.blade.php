...
<?php
  ...
  $sellerCurrency = $product->seller->currency;
  $ngMode= 'auto';
    if(!empty($product->negotiation_mode)) {
        $ngMode= $product->negotiation_mode;
    }
  $currrentUPCCode = '';
  $sellerQty = $product->seller_original_quantity;
        ...
        <div class="accordion accordion-default accordion-toggle accordion-style-1" role="tablist">
          ...
          <div class="card">
            ...
            <div id="toggleCategories" class="accordion-body collapse show" role="tabpanel" aria-labelledby="categories">
              <div class="card-body">
                <ul class="list list-unstyled mb-0" style="font-size: 15px;">
      ...
      <div class="col-md-8 col-lg-9 order-1 mb-5 mb-md-0">
        <div class="row mb-5">
          ...
          <div class="col-lg-7">
            ...
            <p class="mt-4" style="font-size:15px;">{{substr($product->product_description, 0, 50)}}</p>
            <hr class="my-4">
            <ul class="list list-unstyled">
              <li style="font-size:15px;">Quantity: <strong>{{$product->seller_original_quantity}}</strong></li>
              <li style="font-size:15px;">SKU/UPC: <strong>{{$product->upc_product_code}}</strong></li>
              <?php
        ...
        <div class="row mb-5">
          ...
          <ul class="nav nav-tabs nav-tabs-default" id="productDetailTab" role="tablist">
              ...
              <li class="nav-item">
                ...
                @if(strlen($product->upc_product_code) >= 17 && ctype_alnum($product->upc_product_code))
			   <li class="nav-item">
            ...
            <div style="font-size:15px;" class="tab-pane fade pt-4 pb-4" id="productDetailDesc" role="tabpanel" aria-labelledby="productDetailDescTab">
...
<script type="text/javascript">
  ...
  var clientSetCategory = '{{$product->category}}';
   ...
   var ROBO_SELLER_EMAIL = '{{ $prodDataCustomEmail}}';
   var ROBO_NEGOTIATION_MODE = '{{$ngMode}}' ;
   ...
   var ROBO_CURRENCY = '{{$sellerCurrency}}';
