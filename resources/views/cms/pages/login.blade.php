                        ...
                        <div class="row">
                           ...
                           <div class="col-12">
                              <form action="{{route('login.submit')}}" method="post">
                                 ...
                                 <center><div class="col-12 copy-text" style="margin-top:30px; text-align: center; color: #fff;">New User ! <a href="{{route('cms.pages.register')}}">Register now</a></div></center>
                              </form>
                           </div>
                        </div>
                     </div> -->
                        ...
                        <div class="login p-5" style="background-color: #000850; height: 855px; ">
                           ...
                           <div class="login-right" style="margin-top: 200px;">
                              ...
                              <div class="alert alert-info" role="alert">
                                 Login/ Register below to sell your product(s)/ service through negotiation. Buyers can directly visit our<a href="{{route('home.catalog')}}" class="alert-link"> Product Catalog</a>
                              </div>
                               <form action="{{route('login.submit')}}" id="frmSignIn" method="post">
                                 {{csrf_field()}}
                                 <div class="form-row">
                                    {{\App\Http\Controllers\PagesHandler::notification()}}
                              ...
                              <center><div class="col-12 copy-text"><a href="{{route('cms.pages.register')}}"><span style="margin-top:30px; text-align: center; color: #fff !important;">Register now!</span></a></div></center>
                           </div>
                        </div>
                     </div>
                  </div>
