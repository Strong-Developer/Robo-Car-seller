...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <!-- Bootstrap core CSS -->
    <link href="{{asset('css/mycss/bootstrap.min.css')}}" rel="stylesheet">
    <!-- Custom styles for this template -->
    <link href="{{asset('css/mycss/form-validation.css')}}" rel="stylesheet">
...
{{--                <h4 class="mb-3">Complete form below</h4>--}}
                <form class="needs-validation" novalidate="" method="POST" action="{{url('/api_call')}}">
                    @csrf
                    <input type="hidden" class="form-control" id="api_key" name="api_key" value="{{$request->api_key}}">
                    <input type="hidden" class="form-control" id="role" name="role" value="{{$request->role}}">
                    <input type="hidden" class="form-control" id="mode" name="mode" value="{{$request->mode}}">
                    <input type="hidden" class="form-control" id="upc_product_code" name="upc_product_code" value="{{$request->upc_product_code}}">
                    <div class="mb-3">
...
<script src="{{asset('js/myjs/popper.min.js')}}"></script>
<script src="{{asset('js/myjs/bootstrap.min.js')}}"></script>
<script src="{{asset('js/myjs/holder.min.js')}}"></script>
<script>
    ...
    (function() {
        ...
        var selected_role = "{{$request->role}}";
