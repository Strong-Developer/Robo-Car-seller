         ...
         <div class="card-body">
            <section class="dark-grey-text">
                ...
                <div class="panel panel-primary">
                  ...
                  Import CSV Data status
                  </div>
                  <div class="panel-body">
                    <form  enctype="multipart/form-data">
                      {{csrf_field()}}
                      <div class="panel panel-info">
                        <div class="panel-heading">Import CSV Data status</div>
                        <div class="panel-body">
                          <div class="row">
                            <div class="col-md-12">
                               <div class="form-group">
                                  File Name : {{$historyData->actual_name}}
                               </div>
                            </div>
                            <div class="col-md-12">
                               <div class="form-group">
                            ...
                            <?php $hisData = json_decode($historyData->history_data,true); ?>
                            <div class="col-12">
                                <div class="table-responsive">
                                    <div class="data-tables datatable-primary">
                                        <table class="table text-center table-bordered" id="dataTable2">
                                            ...
                                            <tbody>
                                                @foreach($hisData as $prodCode=>$his)
                                                <tr>
                                                    <td>{{$prodCode}}</td>
                                                    <td>{{$his}}</td>
                                                </tr>
