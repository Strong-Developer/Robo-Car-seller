        ...
        <div class="navbar-collapse collapse w-100" id="navbar">
                ...
                <ul class="navbar-nav ml-auto black">
                    ...
                    <li class="nav-item dropdown black">
                        <a class="nav-link font-weight-bold text-white" href="<?php echo e(route('admin.cms.pages')); ?>">Manage Pages</a>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-primary" aria-labelledby="navbarDropdownMenuLink">
                            <a class="dropdown-item" href="<?php echo e(route('admin.cms.edit_page',['post_type' => 'header',
                            'header_id' => 2])); ?>">Header for logged in users</a>
                            <a class="dropdown-item" href="<?php echo e(route('admin.cms.edit_page',['post_type' => 'header'])); ?>">Header for non-logged in guests</a>

                        </div>
                    </li>
                    <li class="nav-item dropdown">
                        <a  href="<?php echo e(route('admin.cms.edit_page',['post_type' => 'footer'])); ?>" class="nav-link nav-link
                        font-weight-bold text-white">
                            <i class="fa fa-file-code"></i> Footer
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link font-weight-bold" href="<?php echo e(route('logout')); ?>" ><i
