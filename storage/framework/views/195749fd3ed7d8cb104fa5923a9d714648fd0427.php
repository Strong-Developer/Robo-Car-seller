                ...
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <form action="<?php echo e(route('discounts_rebates_import.csv')); ?>" method="POST" enctype="multipart/form-data">
                                <?php echo e(csrf_field()); ?>
