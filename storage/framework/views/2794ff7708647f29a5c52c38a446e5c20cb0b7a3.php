...
<legend style="margin-top: -66px;margin-left: 0;z-index: 10;position: relative;"><span>Edit Finance Parameters</span></legend>
<div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="row finance_section existed" id="finance_section_0">
                                        <div class="col-md-4">
                                            ...
                                            <input class="form-control" type="number" value="<?php echo e(isset($productFinanceData->seller_finance_sub_parameters[0]->interest_rate)?$productFinanceData->seller_finance_sub_parameters[0]->interest_rate:''); ?>" name="finance_sub_parameter[0][interest_rate]" required/>
                                        </div>
                                        <div class="col-md-4">
                                    ...
                                    <div class="row finance_section existed" id="finance_section_<?php echo e($counter); ?>">
                                        <div class="col-md-4">
                                            ...
                                            <input value="<?php echo e(isset($productFinanceData->seller_finance_sub_parameters[$counter]->interest_rate)?$productFinanceData->seller_finance_sub_parameters[$counter]->interest_rate:''); ?>" class="form-control" type="number" name="finance_sub_parameter[<?php echo e($counter); ?>][interest_rate]" required/>
                                        </div>
                                        <div class="col-md-4">
