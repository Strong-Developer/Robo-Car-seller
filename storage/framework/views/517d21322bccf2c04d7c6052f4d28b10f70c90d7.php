        ...
        <div class="header-column justify-content-start">
          <div class="header-logo">
            <a href="<?php echo URL::to("/"); ?>">
              <img alt="ROBO" width="200" height="" src="http://market.robonegotiator.com/storage/app/images/1574287980.png">
            </a>
          </div>
        </div>
        <div class="header-column justify-content-end">
                ...
                <ul class="nav flex-column flex-lg-row" id="mainNav">
                  ...
                  <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                      <li><a class="dropdown-item" href="http://market.robonegotiator.com/about-us">About Us</a></li>
                      <li><a class="dropdown-item" href="http://market.robonegotiator.com/how-it-works">How It Works</a></li>
                      <li><a class="dropdown-item" href="http://market.robonegotiator.com/integrate-with-us">Integrate With Us</a></li>
                      <!-- <li class="dropdown-submenu">
                        <a class="dropdown-item dropdown-toggle" href="http://market.robonegotiator.com/integrate-with-us">Integrate With Us</a>
                        <ul class="dropdown-menu">
                          <li><a class="dropdown-item" href="#">I am a buyer</a></li>
                          <li><a class="dropdown-item" href="#">I am a Seller</a></li>
                        </ul>
                      </li> -->
                    </ul>
                  </li>
                  <li class="dropdown">
                    <a class="dropdown-item dropdown-toggle" href="http://market.robonegotiator.com/contact-us">
                      Contact Us
                    </a>
                  </li>
                  <li class="dropdown dropdown-mega dropdown-mega-style-2">
                    <a class="dropdown-item dropdown-toggle" href="<?php echo e(route('home.catalog')); ?>">
                      Product Catalog 
                    </a>
                  </li>
