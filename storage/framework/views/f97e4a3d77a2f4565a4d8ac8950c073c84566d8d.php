            ...
            <section class="dark-grey-text">
                ...
                <div class="panel panel-primary">
                  ...
                  <div class="panel-body">
                    <?php if(! empty($errors_seller) && $errors_seller > 0 ): ?>
                      <div class="alert alert-danger">
                         <?php echo e($errors_seller); ?> Products failed to import
                      </div>
                    <?php endif; ?>
                    <form action="<?php echo e(route('editProduct.submit')); ?>" method="post" enctype="multipart/form-data">
                      <?php echo e(csrf_field()); ?>

                      <input type="hidden" name="pid" value="<?php echo e($product->id); ?>">
                      <input type="hidden" name="request_id" value="<?php echo e($product->request_id); ?>">
                            ...
                            <div class="col-md-6">
                               <div class="form-group">
                                  ...
                                  <select required name="category" onchange="setAttributes(this.value)" class="custom-select" style="display: block
                                     ...
                                     <option <?php if($product->category=="Automobiles"): ?> selected="" <?php endif; ?>>Automobiles</option>
                                     <option <?php if($product->category=="Electronics"): ?> selected="" <?php endif; ?>>Electronics</option>
                                     <option <?php if($product->category=="Appliances"): ?> selected="" <?php endif; ?>>Appliances</option>
                            ...
                            <div class="col-md-6">
                               <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" placeholder="Product Title *" required
                                     value="<?php echo e($product->product_title); ?>"         name="product_title">
                               </div>
                            </div>
                            <div class="col-md-6">
                               <div class="form-group">
                                  ...
                                  <?php endif; ?>
                                  <input type="text" class="form-control" placeholder="Product Code (UPC or SKU or  VIN) *" value="<?php echo e($product->upc_product_code); ?>" required name="upc_product_code" readonly>
                               </div>
                            </div>
                            <div class="col-md-6">
                               <div class="form-group">
                                  <input type="text" class="form-control" placeholder="URL(More Information)
                                     (Optional)"
                                     name="url" value="<?php echo e($product->url); ?>">
                               </div>
                            </div>
                            <div class="col-md-12">
                              <div class="form-group">
                                <textarea class="form-control" placeholder="Enter Some Product Description to Proceed" rows="5" id="product_description" name="product_description"><?php echo e($product->product_description); ?></textarea>
                              </div>
                            </div>
                            <!-- image view -->
                            <div align="center" id="img-contaioner">
                              <div class="col-md-12">
                                <div class="form-group">
                                  ...
                                  <img src="<?php echo e($image->main_file_path); ?>" width="200px">
                      ...
                      <div class="panel panel-danger">
                        ...
                        <div class="panel-body">
                          <div class="row">
                            ...
                            <div class="col-md-6">
                               <div class="form-group">
                                  <input type="text" class="form-control" placeholder="Special RoboNegotiator Deal  Price *" name="special_deal_price" value="<?php echo e($product->special_deal_price); ?>">
                               </div>
                            </div>
                            <div class="col-md-6">
                               <div class="form-group">
                                  ...
                                  <?php if(Auth::user()->negotiation === 'auto'): ?> required  <?php endif; ?>   value="<?php echo e($product->lowest_price); ?>">
                               </div>
                            </div>
                            <div class="col-md-6">
                               <div class="form-group">
                                  ...
                                  <?php endif; ?>
                                  <input type="text" class="form-control" placeholder="Quantity Available for this deal *" required name="seller_original_quantity" value="<?php echo e($product->seller_original_quantity); ?>">
                               </div>
                            </div>
                            ...
                            <div class="col-md-6">
                               <div class="form-group">
                                  ...
                                  <input type="text" onfocus="(this.type='date')" class="form-control" placeholder="Deal Expiry Date *"
                                     id="datePicker" name="expiry_date" value="<?php echo e($product->deal_expiry_date); ?>" required>
                               </div>
                            </div>
                          </div>
                        </div>
                          <div class="panel panel-primary">
                              ...
                              <div class="panel-body">
                                  <div class="row">
                                      <div class="col-md-12">
                                          <div class="form-group">
                                              <label><input type="radio" name="negotiation" <?php if($product->negotiation_mode == "classic"): ?> checked <?php endif; ?> value="classic"   style="padding-right: 5px; color: #fff;"> &nbsp;I would like to negotiate myself.</label>
                                          </div>
                                      </div>
                                      <div class="col-md-12">
                                          <div class="form-group">
                                              <label><input type="radio" name="negotiation" <?php if($product->negotiation_mode == "auto"): ?> checked <?php endif; ?> value="auto" style="padding-right: 5px; color: #fff"> &nbsp;I would like RoboNegotiator to expedite/do negotiations.</label>
                                          </div>
                                      </div>
                                  </div>
                              </div>
