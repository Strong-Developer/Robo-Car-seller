      ...
      <div class="col-md-8 col-lg-9 order-1 mb-5 mb-md-0">
        <div class="row mb-5">
          ...
          <div class="col-lg-7">
            ...
            <p class="mt-4" style="font-size:15px;"><?php echo e(substr($product->product_description, 0, 50)); ?></p>
            <hr class="my-4">
            <ul class="list list-unstyled">
              <li style="font-size:15px;">Quantity: <strong><?php echo e($product->seller_original_quantity); ?></strong></li>
              <li style="font-size:15px;">SKU/UPC: <strong><?php echo e($product->upc_product_code); ?></strong></li>
              <?php
...
<script type="text/javascript">
  var ROBO_QUANTITY = '<?php echo e($sellerQty); ?>';
  var clientSetCategory = '<?php echo e($product->category); ?>';
   ...
   var ROBO_CURRENCY = '<?php echo e($sellerCurrency); ?>';
