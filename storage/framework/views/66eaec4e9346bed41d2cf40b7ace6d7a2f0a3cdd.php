         ...
         <div class="card-body">
            <section class="dark-grey-text">
                <div class="alert alert-info" role="alert">
                    <p><b>RoboNegotiator</b> Update Discounts/Rebates</p>
                </div>
                ...
                <div class="panel panel-primary">
                  ...
                  Update Discounts/Rebates
                  </div>
                  <div class="panel-body">
                    <form action="<?php echo e(url('update-product-discount-rebate')); ?>" method="post">
                      <?php echo e(csrf_field()); ?>

                      <?php $yearEnd = date('Y-m-d', strtotime('Dec 31'));  ?>
                      <div class="panel panel-info">
                        <div class="panel-heading">Discounts/Rebates</div>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="row">
                                    ...
                                    <br>
                                    <input type="hidden" name="product" value="<?php echo e($discount_data->upc_product_code); ?>">
                                    <input type="hidden" name="discount_id" value="<?php echo e($discount_data->id); ?>">
                                    <div class="row discount_section" id="discount_section_0">
                                        <div class="col-md-2">
                                            <input type="checkbox" <?php if($discount_data->applicability == 'all'): ?> checked value="all" <?php endif; ?> name="discount_types[0][applicability]">&nbsp;|&nbsp;
                                            <input required style="margin: -21px 0 0 22px;" class="form-control" placeholder="Discount/Rebate" type="text" name="discount_types[0][title]" value="<?php echo e($discount_data->title); ?>">
                                        </div>
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-2">
                                            <div class="input-group mb-3">
                                                ...
                                                <input aria-describedby="basic-addon-0" class="form-control" placeholder="Amount" type="number" min="1" name="discount_types[0][amount]" value="<?php echo e($discount_data->amount); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-2"><input class="form-control" placeholder="Unlimited" type="number" min="1" name="discount_types[0][qty]" value="<?php echo e($discount_data->qty); ?>"></div>
                                        <div class="col-md-2"><input class="form-control discount_expiry_date" value="<?php echo e($yearEnd); ?>" placeholder="Expiry Date" type="text" name="discount_types[0][expiry_date]" value="<?php echo e($discount_data->expiry_date); ?>"></div>
                                    </div>
                                    <br>
                                    <div id="append-after">
                                    </div>
                      ...
                      <div class="col-md-12">
                         <button type="submit" id="up_button" onclick="disable_upload_button()" class="btn btn-lg btn-block" style="background-color: #00aeef; color: #fff;">
