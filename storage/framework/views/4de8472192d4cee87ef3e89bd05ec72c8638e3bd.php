               ...
               <div class="row flex-center" >
                ...
                <div class="panel panel-primary">
                  <div class="panel-heading">
                    ...
                    <a style="margin-top: -15px;margin-right:5px;" href="<?php echo e(url('/import-history')); ?>" class="btn btn-success btn-flat btn-lg float-right"><i class="fa fa-upload" aria-hidden="true"></i> Import History & Status</a>
                  ...
                  <div class="panel-body">
                    ...
                    <form action="<?php echo e(route('addProduct.submit')); ?>" method="post" id="add-deal-form" enctype="multipart/form-data">
                      <?php echo e(csrf_field()); ?>
