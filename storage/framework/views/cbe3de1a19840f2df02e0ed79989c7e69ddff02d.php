                          ...
                          <div class="row">
                            ...
                            <div class="col-md-6">
                               <div class="form-group">
                                  ...
                                  <?php endif; ?>
                                  <input type="text" class="form-control" placeholder="Product Code (UPC or SKU or  VIN) *" value="<?php echo e($product->upc_product_code); ?>" required name="upc_product_code">
                               </div>
                            </div>
                            <div class="col-md-6">
                               <div class="form-group">
                            ...
                            <div class="col-md-12">
                              <div class="form-group">
                                <textarea class="form-control" required placeholder="Enter Some Product Description to Proceed" rows="5" id="product_description" name="product_description"><?php echo e($product->product_description); ?></textarea>
                              </div>
                            </div>
                            <!-- image view -->
                            <div align="center" id="img-contaioner">
                              <div class="col-md-12">
                                ...
                                <div class="form-group">
                                  <button type="button" class="btn btn-danger remove-img"><i class="fa fa-trash"></i> Remove Existing Image and Add New Image</button>
                                </div>
                              </div>
                            </div>
                            <!-- File Upload Section -->
                            ...
                            <div class="col-md-6">
                               <div class="form-group">
                                  ...
                                  <input type="text" onfocus="(this.type='date')" class="form-control" placeholder="Deal Expiry Date *"
                                     id="datePicker" name="expiry_date" value="<?php echo e(date('d-m-Y', strtotime($product->deal_expiry_date))); ?>" required>
                               </div>
                            </div>
                          </div>
                        </div>
